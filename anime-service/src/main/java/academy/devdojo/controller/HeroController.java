...
public class HeroController {
    ...
    private static final List<String> HEROES = List.of("Ash", "Tanjiro", "Denku", "All Mighty");
    ...
    @GetMapping("filter")
    public List<String> listAllHeroesParam(@RequestParam(required = false, defaultValue = "Denku") String name) {
    ...
    public String findByName(@PathVariable String name) {
        return HEROES
                .stream().filter(hero -> hero.equalsIgnoreCase(name))
                .findFirst()
                .orElse("Não achou");
    }
}
